<?php
	...
	*/
	...
	$username = "natalia";
	$password_old = "nataliafof";
	$password_new = "natalialegal";
...
if (mysqli_num_rows($result) > 0) {
    ...
    if ($row["user_password"] <> $password_old) {
    	echo "SENHA ERRADA!"; // TRATAR SENHA ERRADA CORRETAMENTE
    } else {
    	$sql2 = "UPDATE User SET user_password='{$password_new}' WHERE user_login = '{$username}'";
